      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="mb-6 bg-white p-4 shadow rounded-lg">
          ...
          <div>
            ...
            { data?.user?.subscriptionPlan === 'Trial' && <p className="border mb-2 rounded w-full py-2 px-3 text-gray-700 leading-tight">Trial : 1000 monthly request</p> }
            { data?.user?.subscriptionPlan === 'Free' && <p className="border mb-2 rounded w-full py-2 px-3 text-gray-700 leading-tight">Free : 5 monthly request</p> }
            { data?.user?.subscriptionPlan === 'Basic' && <p className="border mb-2 rounded w-full py-2 px-3 text-gray-700 leading-tight">Basic : 50 monthly request</p> }
            { data?.user?.subscriptionPlan === 'Premium' && <p className="border mb-2 rounded w-full py-2 px-3 text-gray-700 leading-tight">Basic : 100 monthly request</p> }
            <Link
              to="/plans"
        ...
        <div className="mb-6 bg-white p-4 shadow rounded-lg">
          ...
          <div>
            <p className="mb-4">Trial Status: {data?.user?.trialActive ? 
            <span className="text-green-500">Active</span> : <span className="text-yellow-600">Inactive</span>}</p>
